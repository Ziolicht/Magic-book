...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      output = {for (var element in input) element: element};
    ...
    () {
      ...
      List<int>? output = input.map((map) => map["amount"]!).toList();
    ...
    () {
      ...
      List<bool>? output =
          input.split(",").map((e) => e.trim() == "true").toList();
      // --- End of Answer ---
    ...
    () {
      ...
      List<String>? output = input.split(",").map((e) => e.trim()).toList();
    ...
    () {
      ...
      DateTime input1 = DateTime.parse("2022-01-01");
      DateTime input2 = DateTime.parse("2023-02-02");
      DateTime input3 = DateTime.parse("2024-03-03");
      List<DateTime>? output = [input1, input2, input3];
    ...
    () {
      ...
      List<double>? output =
          input.split(",").map((e) => double.parse(e.trim())).toList();
    ...
    () {
      ...
      String input = "true,false,true,false,true";
      List<bool>? output =
          input.split(",").map((e) => e == "true").cast<bool>().toList();
    ...
    () {
      ...
      return price is double && price == 100.24;
      return price == 100.24;
    },
    ...
    */
    ...
    () {
      ...
      List<int>? output = numbers..sort((a, b) => a.compareTo(b));
    ...
    () {
      ...
      List<int>? output = numbers..sort((a, b) => b.compareTo(a));
    ...
    () {
      String text = "Dart is awesome";
      // Implementasikan kode untuk mengganti kata "awesome" pada variable text dengan kata "fantastic".
      String? output = "Dart is fantastic";
      return output == "Dart is fantastic";
    },
    ...
    () {
      ...
      String? output = "Dart is awesome and Flutter";
